...
func TestVersionedRemainingRoutesPreserveLegacyContracts(t *testing.T) {
	...
	cases := []remainingVersionedRouteCase{
		...
		{name: "delivery-templates", method: http.MethodGet, versionedPath: "/api/v1/delivery-templates", legacyPath: "/delivery-templates", wantStatus: http.StatusOK},
		{name: "delivery-template-create-invalid", method: http.MethodPost, versionedPath: "/api/v1/delivery-templates", legacyPath: "/delivery-templates", body: `{}`, wantStatus: http.StatusBadRequest},
		{name: "delivery-template-get-invalid", method: http.MethodGet, versionedPath: "/api/v1/delivery-templates/invalid", legacyPath: "/delivery-templates/invalid", wantStatus: http.StatusBadRequest},

...
func (s *Server) mountVersionedAutomationRoutes(r chi.Router) {
	r.Group(func(r chi.Router) {
		...
		r.Get("/api/v1/delivery-templates", s.listDeliveryTemplates)
		r.Post("/api/v1/delivery-templates", s.createDeliveryTemplate)
		r.Get("/api/v1/delivery-templates/{template_id}", s.getDeliveryTemplate)
		r.Put("/api/v1/delivery-templates/{template_id}", s.updateDeliveryTemplate)
		r.Delete("/api/v1/delivery-templates/{template_id}", s.deleteDeliveryTemplate)
